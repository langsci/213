...
\glft `Three young beautiful girls came (and) fetched water' \trailingcitation{(Julio\_goat 99)}\ 
\z
\xe
...
\glft `They brought fish (and) ate together' \trailingcitation{(Julio\_goat 49)}\ 
\z
\xe
...
\glft `In the afternoon his brother came back' \trailingcitation{{\small (Julio\_goat 66)}}\ 
\z
\xe
...
\glft `After having arrived, he asked' \trailingcitation{{\small (Julio\_goat 67)}}\\
\z
\xe
...
\glc then child little \acs{det}:\acs{sg} $<$\acs{3}\acs{sg}$>$go come $<$\acs{3}\acs{sg}$>$steal \acs{3}\acs{sg}:\acs{poss} \sc{loc}:\acs{ana}\\
...
\glft `he took (it and) went (off)' \trailingcitation{{\small (WBW\_pear\_Mart)}}\ 
\z
\xe
...
\glft `he took (it and) went off' \trailingcitation{{\small (WBW\_pear\_Oni)}}\ 
\z
\xe
...
\glft `he took it (and) went (off) \trailingcitation{{\small (WBW\_pear\_Sofi)}}\
\z
\xe
...
\glft `he took (it) and went off, leaving him (the man) behind' \trailingcitation{{\small (WBW\_pear\_Abra)}}\ 
\z
\xe
...
From the examples so far we have seen that categorizing and linguistically expressing a sequence of real world dynamics entails both lexicalization and collocization of certain event conceptions, on different levels and with different conditions in place. 
...
\glft 'Sharks, four of them came'  \trailingcitation{{\small (Julio\_goat 309,310)}}\ 
\z
\xe
...
\glft `I pour water into the thermos flask' \trailingcitation{{\small (Dol 2007: 77)}}\ 
\z
\xe
...
wa'i-n laka buni karbau ruo kudo ke de mai huba \\
\glc older.brother-\textsc{n} go look buffalo and horse \acs{dem} \acs{neg} come fast\\
\glft 'His brother went (and) looked after the cattle, (and) he didn't came (back) fast/early' \trailingcitation{(Julio\_goat 057)}\ 
\z
\xe
...
\includegraphics[width=1.0\textwidth]{../eventschemav2.eps} 
...
\glc 3\acs{pl}-eye \acs{dir} $<$3\acs{sg}$>$carry=\acs{obj}.\acs{sg} go 3\acs{sg}-give \acs{dir} 3\acs{sg}\\
...
\glc 3\acs{pl}-eye \acs{dir} 3\acs{sg} $<$3\acs{sg}$>$carry=\acs{obj}.\acs{sg} go 3\acs{sg}-give \acs{dir} 3\acs{sg}\\
\glft  \trailingcitation{{\small (elicited)}}\ 
\z
\xe
...
\glc 3\acs{du}-go 3\acs{du}-be.at 3\acs{du}-call search=\acs{obj}.\acs{sg} \acs{loc} forest\\
\glft `Both of them went out into the forest and searched (for the frog)' \trailingcitation{{\small (frogstory\_Kosmus)}}\ 
\z
\xe
...
\glft `(The animal) will die and remain there' (lit. `it will die lie there') \trailingcitation{{\small (poison\_for\_animals)}}\ 
\z
\xe
...
\glft `We go home fast' \trailingcitation{{\small (HIVIAY\_exp 077)}}\ 
\z
\xe
...
\includegraphics[width=1.0\textwidth]{../eventschemamod.eps} 
...
\ea%[glhangstyle=none] \label{Jackendoff03} Ascription of properties
...
Evidently, the use of \textsc{go} (or \textsc{move}, for that matter
...
\pex \label{WP_27}
\ea
%\rightcomment{\textbf{Western Pantar}}
\gll mis gatta biring wa \\
stay already run go.\acs{trans} \\
\glft `(They) stayed and then afterward they ran away' \trailingcitation{(Holton 2014: 85)}\ 
\z
\xe
...
\pex \label{WMH_Julio_goat049_4}
\ea
%\rightcomment{\textbf{Waima'a}}
\gll \textbf{ani} ike \textbf{mai} wuruo ramhutu khaa \\
ani ike mai wuo-ruo ramhutu khaa \\
\glc bring fish come \acs{clf}-two together eat\\
\glft `They brought fish (and) ate together' \trailingcitation{(Julio\_goat 049)}\ 
\z
\xe
...
\glft `The every(day) I came and got my friends...' \trailingcitation{{\small (Reesink 1999: 99)}}\ 
\z
\xe
...
\glc 1\acs{pl}.\acs{ex}-climb 1\acs{pl}.\acs{ex}-take fruit \acs{det}:\acs{dist}:\acs{pl}\\
...
\glft `(the head of the snake) would come up' \trailingcitation{{\small (ular\_MANDOMAS 122)}}\ 
\z
\xe
...
\glft `The gospel is what he brought' (lit. `... went and took (along)') \trailingcitation{{\small (Klamer 1998: 323)}}\ 
\z
\xe
...
\glft `I throw the ball away' (lit. 'I throw the ball and it goes') \trailingcitation{{\small (Dol 2007: 214)}}\ 
\z
\xe
\ea \label{Taba_17}
 %[glhangstyle=none]
...
\glc 3\acs{sg}.\acs{poss} mother=\acs{pl} 3\acs{sg}=hit 3\acs{sg} 3\acs{sg}=burp-\acs{appl} milk\\
\glft `His mother hit him and he burped milk/ his mother burped milk from him' \trailingcitation{{\small (Bowden 2001: 311)}}\ 
\z
\xe
...
\gll ait ro m-kah \nogloss{Ø} ø-tim am y-hu Sorong\\
3\acs{m} \acs{rel} 3\acs{u}-to ø-send letter 3\acs{m}-stay S. \\
\glft `He to/for whom I'm sending a letter lives in Sorong' \trailingcitation{{\small (Dol 2007: 207)}}\ 
\z
\xe
...
\glft `So they put her down and he came and took her...' \trailingcitation{{\small (de Vries 2004: 85)}}\ 
\z
\xe
...
\glft `He came back (and) roasted the fish' \trailingcitation{{\small (MOB\_1\_EW 082)}}\ 
\z
\xe
...
\glft `He made that cloth yellow' \trailingcitation{{\small (Klamer 2014: 139)}}\ 
\z
\xe
\ea \label{Tukang38}
...
ta-ong hara-a mara \\
\glc 1\acs{pl}.\acs{in}-make wrong-\acs{obj}.\acs{pl} \acs{top}\\
\glft `(something that we learn), if we make it wrong...' \trailingcitation{{\small (MANTERA\_magic\_charms 006)}}\ 
\z
\xe
...
would go meet him') \trailingcitation{{\small (van den Heuvel 2006: 391)}}\ 
\z
\xe
...
\glft `They went down the stairs and ran...' \trailingcitation{{\small (Odé 2002: 96)}}\ 
\z
...
\glft `Descendants everywhere were told.' (lit. descendants everywhere were run to and swum to so they told them) \trailingcitation{{\small (Baird 2008: 138)}}\ 
\z
\xe
