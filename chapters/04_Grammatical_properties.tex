...
\glft `Grind it and let it not be too fine.' \trailingcitation{{\small (Ameka 2005: 18)}}\\ 
\z
\xe
...
\glft `He took one (frog and) threw (it)' \trailingcitation{{\small (frogstory\_Kosmus)}}\\ 
\z
\xe
...
\glc 3\acs{du} 3\acs{du}-go 3\acs{du}-fall.into.water \acs{loc}.\acs{ana} \\
\glft `The two of them fell into the water at (that place)' \trailingcitation{{\small (frogstory\_Kosmus)}}\\ 
\z
\xe
...
\glc 1\acs{sg}:\acs{im}.\acs{fut}-take-2\acs{sg} 1\acs{du}.\acs{in}-\acs{im}.\acs{fut}-go \\
\glft 'I will take you away with me' \trailingcitation{{\small (Crowley 2002: 41)}}\\ 
\z
\xe
...
\begin{figure}
\includegraphics[width=\columnwidth]{../R/plots/Referentiality_Family.eps}
...
\end{figure}
\begin{figure}
\includegraphics[width=\columnwidth]{../R/plots/Referentiality_Group.eps}
...
\glft `They went for their mother to the market' \trailingcitation{{\small (Donohue 1999: 201)}}\\ 
\z
\xe
\ea \label{}
%\begingl
...
\glft `We all came to Morotai to work' \trailingcitation{{\small (Holton 2003: 43)}}\\ 
\z
\xe
\ea \label{}
%\begingl
...
\glft `They don't go (to) sleep in the house (at home)' \trailingcitation{{\small (Reesink 1999: 108)}}\\ 
\z
\xe
...
\glc 3\acs{sg}=wash 1\acs{sg}.\acs{poss} T-shirt 3\acs{sg}=\acs{caus}-be.white \\
\glft `She washed my T-shirt white' \trailingcitation{{\small (Bowden 2011: 311)}}\\ 
\z
\xe
\ea \label{mpur001}
%\begingl[glhangstyle=none]
...
\glft `She took off that cloth and threw the child away and it died' \trailingcitation{{\small (Odé 2002: 98)}}\\ 
\z
\xe
...
\glc 1\acs{sg} 1\acs{sg}:\acs{dist}.\acs{fut}-hit pig 3\acs{sg}:\acs{dist}.\acs{fut}-die \\
...
\glc 1\acs{sg}-take fit glass 3\acs{sg}.\acs{spec}-this not \acs{sim} 1\acs{sg}-strike.hard shatter 3\acs{sg} \\
\glft `I did not pick up the glass rightly so that I struck and made it shatter.' \trailingcitation{{\small (van den Heuvel 2006: 194)}}\\ 
\z
\xe
...
\glft `The machete descended (and) struck his head splitting it completely.’ \trailingcitation{{\small (Schapper 2009: 447)}}\\ 
\z
\xe

Example (\ref{maybrat001}) from Maybrat below illustrates another quite freqent pattern, this time with a \textsc{theme} object becoming the subject of V$_2$ in what I call direction complex constructions. Literally, it would mean `Should I pour water go(es) into the thermos flask'.
...
\glft `He swallowed everything this way’ \trailingcitation{{\small (Kratochvíl 2007: 372)}}\\ 
\z
\xe
...
\glft `She met an old man with a stick who had been hunting' \trailingcitation{{\small (van den Berg 1989: 241)}}\\ 
\z
\xe
...
\glft `Let's go and do some fishing, Dear Monkey' \trailingcitation{{\small (Donohue 1999: 516)}}\\ 
\z
\xe
\ea \label{selaru001o}
%\begingl[glhangstyle=none]
...
\glft `He requested they give the food so that woman and that man [can] eat until done' \trailingcitation{{\small (Coward 2005: 120)}}\\ 
\z
\xe
...
\glft \trailingcitation{{\small (Dol 2007: 80)}}\\ 
\z
\xe
...
\glft `he looks up’ \trailingcitation{{\small (Kratochvíl 2007: 363)}}\\ 
\z
\xe
\ea \label{}
%\begingl
...
\gll Lkiu kwat \\
l=kiu kwat \\
\glc 3\acs{pl}=be.frightened be.strong(\acs{emph}) \\
\glft `They were really frightened' \trailingcitation{{\small (Bowden 2001: 315)}}\\ 
\z
\xe
\ea \label{waimaqa007}
%\begingl
%\rightcomment{{\small \textbf{Waima'a} \textsc{pap}}}
\gll nau hite ma'a lo, + den te ma'a lo \\
know \acs{ptl} finish \acs{asp} hear \acs{ptl} finish \acs{asp} \\
\glft `(you) already know, have already heard (...)' \trailingcitation{{\small (dom2\_kaben 219f.)}}\\ 
\z
\xe
...
\glft `He finished eating it (completion of action)' \trailingcitation{{\small (Grimes 1991: 160)}}\\ 
\z
\xe
...
\glft `I came out with tears falling' \trailingcitation{{\small (Holton 2003: 61)}}\\ 
\z
\xe
...
\glft `In the middle of the night (I) will come here to sneak around.’ \trailingcitation{{\small (Mayani 2013: 294)}}\\ 
\z
\xe
\ea \label{tajio002}
%\begingl
...
\glft `She came to visit her friend.’ \trailingcitation{{\small (Mayani 2013: 294)}}\\ 
\z
\xe
...
\glft `Tomorrow we will go there and put up our fences here and there' \trailingcitation{{\small (Holton 2014: 90)}}\\ 
\z
\xe
\ea \label{lama_2}
%\begingl
...
\glft `Let's (just) the two of us go' \trailingcitation{{\small (Holton 2014: 88)}}\\ 
\z
\xe
...
\glft `The woman that Agus beat is named Susan' \trailingcitation{{\small (elicit.)}}\\ 
\z
\xe
...
\begin{figure}
\includegraphics[width=\columnwidth]{../R/plots/Headedness_Family.eps}
...
\end{figure}
\begin{figure}
\includegraphics[width=\columnwidth]{../R/plots/Headedness_Group.eps}
...
\glft 'As for him, he knows all (the story)' \trailingcitation{{\small (ikan\_ANDAWA\_ANTANAY)}}\\ 
\z
\xe
...
Mead and Youngman (2008) refer to MVCs that only have the first verb inflected as dependent serialisation, and they offer plenty of examples from Tolaki. In many of their examples, however, the first verb in sequence is not a semantically full-fledged verb that would add to the event frame of the construction, but rather a verboid with a grammatical rather than a semantic function. Therefore, when analysing such strings as a matrix construction featuring a grammaticalised verb on the one hand and a nested construction on the other, the nested construction would end up being annotated as ``N" since inflection is only attached to the matrix level verb. Here are two examples, each with a nested motion construction.
...
\glft `At that point Anawaingguluri went down and peered down at the base of the mortar.' \trailingcitation{{\small (Mead and Youngman 2008: 116)}}\\ 
\z
\xe
...
\glc 1\acs{sg}.\acs{abs} \acs{irr}-\acs{sf}-go.down \acs{irr}-\acs{sf}-fish \acs{loc}=ocean \\
\glft `I will go down to fish in the ocean' \trailingcitation{{\small (Quick 2007: 355)}}\\ 
\z
\xe
\ea \label{}
%\begingl
...
\glft `Tomorrow we will go fishing together in the sea' \trailingcitation{{\small (van den Berg 1989: 236)}}\\ 
\z
\xe
...
\glft `... you beat and murdered him until he died' \trailingcitation{{\small (Coward 2005: 125)}}\\ 
\z
\xe
...
\glft `They were (standing) around him.’ \trailingcitation{{\small (Gravelle 2010: 296)}}\\ 
\z
\xe
...
\glft `he went on and on and on and he arrived' \trailingcitation{{\small (de Vries 2004: 48f.)}}\\ 
\z
\xe
\ea \label{inan2}
%\begingl
...
\glft `At the side they used to fill the chamber with gunpowder' \trailingcitation{{\small (de Vries 2004: 47)}}\\ 
\z
\xe
\ea \label{inan3}
%\begingl
...
\glft `they pierced it repeatedly and then it would fall' \trailingcitation{{\small (de Vries 2004: 44)}}\\ 
\z
\xe
...
\glft `She cooked the vegetables for her children' \trailingcitation{{\small (Donohue 1999: 182)}}\\ 
\z
\xe
\ea \label{tukang002}
%\begingl
...
\glft `La Mbagi beat the machete blade straight' \trailingcitation{{\small (Donohue 1999: 183)}}\\ 
\z
\xe
...
\glft `He came yet again to ask me again' \trailingcitation{{\small (Klamer 1998: 339)}}\\ 
\z
\xe
\ea \label{kambera002}
%\begingl[glhangstyle=none]
...
\glft `(and) he (=J) was inside in the middle of talking, then he (=older brother) punched him (=J) ...' \trailingcitation{{\small (Klamer 1998: 357)}}\\ 
\z
\xe
...
\begin{figure}
\includegraphics[width=\columnwidth]{../R/plots/Contiguity_Family.eps}
...
\end{figure}
\begin{figure}
\includegraphics[width=\columnwidth]{../R/plots/Contiguity_Group.eps}
...
\glft `Here he settled, and he brought across pieces of iron for his smithy.' \trailingcitation{{\small (de Vries 2004: 44)}}\\ 
\z
\xe
...
\glc 3\acs{sg}.\acs{abs} \acs{rls}-\acs{sf}-carry y.sibling=3\acs{sg}.\acs{gen} yonder \acs{ug}:\acs{irr}-go.down \acs{loc}=edge \acs{cn}:\acs{gen}=ocean \\
\glft `She carried her baby sister down to the edge of the ocean' \trailingcitation{{\small (Quick 2007: 345)}}\\ 
\z
\xe
...
\glft `going to the market the two would meet' \trailingcitation{{\small (dom2\_kaben 22, 23)}}\\ 
\z
\xe
...
\glft `You come to go see (him) with your own eyes first.' \trailingcitation{{\small (Reesink 2002a: 214)}}\\ 
\z
\xe
\ea \label{sougb002}
%\begingl
...
\glft `Or the two of them were opposite to each other' \trailingcitation{{\small (Reesink 2002a: 217)}}\\ 
\z
\xe
...
\glc 1\acs{pl}.\acs{in}-take \acs{abl} \acs{med} again in.order.to 3\acs{sg}-follow-\acs{vblz}-understand \\
\glft `We have to take (knowledge) from it as well, so that she also understands' \trailingcitation{{\small (midwife\_traditional\_medicine 21, 22)}}\\ 
\z
\xe
\ea \label{wooi004}
%\begingl
...
\glft `He (the Dutch) ruled until he (the Japanese) also came in' \trailingcitation{{\small (zaman\_Belanda 118)}}\\ 
\z
\xe
...
\glft `The faster the crow flew, the faster the dog ran.' (lit. 'its fastness, the crow flew, its fastness also the dog ran') \trailingcitation{{\small (van den Berg 1989:343)}}\\ 
\z
\xe
...
\glft `In the middle of the night, they get into bed to sleep' \trailingcitation{{\small (Klamer 2011: 130)}}\\ 
\z
\xe
...
\glft `So then we walked around again, came home ...' \trailingcitation{{\small (Reesink 1999: 97)}}\\ 
\z
\xe
...
\glft `(one of them came running), he came to divide (it) up' \trailingcitation{{\small (pear\_Santina 203)}}\\ 
\z
\xe
