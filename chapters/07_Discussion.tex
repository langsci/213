...
\includegraphics[width=.5\columnwidth]{../R/plots/CREL_group.eps}
\includegraphics[width=.5\columnwidth]{../R/plots/MOD_group.eps}
\includegraphics[width=.5\columnwidth]{../R/plots/SREL_group.eps}
\includegraphics[width=.5\columnwidth]{../R/plots/FJUX_group.eps}
...
\begin{figure}
\includegraphics[width=\columnwidth]{../R/plots/MVCs_languages.eps}
...
\begin{figure}
\includegraphics[width=1.2\textwidth]{../R/plots/constructions_tokens.eps}
...
\glft `We walked slowly, putting (them) in the place, then we rested, [...]' \trailingcitation{{\small (Baird 2008: 140)}}\\ 
\z
\xe
...
\glft `At midday, she went up to the village' \trailingcitation{{\small (Klamer 2014a: 138)}}\\ 
\z
\xe
...
\begin{figure}
\includegraphics[width=1.2\textwidth]{../R/plots/number_stackedMVC.eps}
...
\begin{figure}
\includegraphics[width=1.2\textwidth]{../R/plots/index_MVCcomplexity.eps}
...
\begin{sidewaysfigure}
\includegraphics[width=\textwidth]{../Maps/map_overview_klein_MVCuse_alt.eps}
...
\glft `we clear it until clean (and) plant it' \trailingcitation{{\small (gardening\_exp1)}}\\ 
\z
\xe
...
\includegraphics[width=1.2\textwidth]{PRAAT/gardening1_burnplant.eps} 
...
\glft `I carry it hither and put it into a bottle' \trailingcitation{MANTERA\_magic charms}\\
\z
\xe
...
\a
%\begingl[glhangstyle=none]
%\rightcomment{\small \textbf{Korafe}}
...
\glft `Their bodies arose, floated and came up and...' \trailingcitation{{\small (de Vries 2006: 816, quoted from Farr 1999: 338)}}\\ 
\z
\xe
...
\glft `they cut the Huko (to) twine a rope' \trailingcitation{{\small (Julio\_goat 26--29)}}\\
\z
\xe
...
\glft `And while she still gave birth to Man, and while she still thought: ``What shall I do?" (it happened that) the pig had given birth to Man.' \trailingcitation{{\small (\cite[][308]{heeschen1998eipo})}}\\ 
\z
\xe
...
\glft `I stand (and) raise up my hands toward the forest' \trailingcitation{{\small (MANTERA\_magic\_charms 22--26)}}\\ 
\z
\xe
